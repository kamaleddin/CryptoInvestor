...
def main():
    ...
    print()
    print("Trade-off:")
    print("  ⚠️  Higher autocorrelation (92-98% vs 75-94%)")
    print("  ⚠️  But still manageable with proper corrections")
    print()
    ...
    for duration in ['1-Year', '2-Year', '3-Year', '4-Year']:
        if duration in results:
            ...
            print(f"  Quarterly (13w):   {quarterly_n:>4} sims  (75% overlap) ⚠️  Previous version")
